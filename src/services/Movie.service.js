const data =  { 
    ...
    "the-dark-knight-rises": {
      ...
      "subtitle": "TDKR",
      "description": "Batman encounters the mysterious Selina Kyle and the villainous Bane, a new terrorist leader who overwhelms Gothams finest.The Dark Knight resurfaces to protect a city that has branded him an enemy ",
...
export default class MovieService {  
    ...
    updateMovieByProp(id,prop, newValue) {
        data[id][prop] = newValue;
    }
}
